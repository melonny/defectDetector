...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataroot', default='D://good_dataset', help='path to dataset')
        ...
        self.parser.add_argument('--display_server', type=str, default="http://127.0.0.1", help='visdom server of the web display')
        ...
        self.parser.add_argument('--abnormal_class', default='defect', help='Anomaly class idx for mnist and cifar datasets')
        ...
        self.parser.add_argument('--save_image_freq', type=int, default=5, help='frequency of saving real and fake images')
        self.parser.add_argument('--save_test_images', action='store_true', help='Save test images for demo.')
        self.parser.add_argument('--load_weights', type=str, default='', help='Load the pretrained weights')
