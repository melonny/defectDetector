...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dataroot', default='F://data', help='path to dataset')
        ...
        self.parser.add_argument('--model', type=str, default='aesiamese', help='chooses which model to use. ganomaly')
